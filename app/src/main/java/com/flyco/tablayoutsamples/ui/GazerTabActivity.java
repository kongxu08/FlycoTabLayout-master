...
public class GazerTabActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gazer_tab);

        for (String title : mTitles) {
            mFragments.add(SimpleWebViewFragment.getInstance(title));
        }
